...
class BaseConfig:
    ...
    DATASET = "MENINGIOMA_TUMOR"  # Cambiado para reflejar el nuevo dataset
    DATASET_PATH = "IngenieroMor/BRAINS_MENINGIOMA_TUMOR"  # Actualiza con la ruta de tu dataset en Hugging Face
