...
gpu_to_use = 0  # Cambia este valor a 0 o 1 según la GPU que desees usar
...
class BaseConfig:
    ...
    DATASET = "NO_TUMOR"  # Cambiado para reflejar el nuevo dataset
    DATASET_PATH = "IngenieroMor/BRAINS_NO_TUMOR"  # Actualiza con la ruta de tu dataset en Hugging Face
